 ...
 *
 * 例子：
 * EditTextWithClear cardNum_et = (EditTextWithClear) findViewById(R.id.card_num_et);
 bankCardNumAddSpace(cardNum_et);

 EditTextWithClear phone_num_et = (EditTextWithClear) findViewById(R.id.phone_num_et);
 phoneNumAddSpace(phone_num_et);
 }
 *
 * </pre>
 */
